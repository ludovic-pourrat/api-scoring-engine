...
- `POST /compliance/score`
  - **Purpose**: Scores an API based on developer experience, mocking readiness, and API standard conformance.
...
- `POST /owasp/score`
  - **Purpose**: Scores an API against the OWASP Top 10 security risks.
  - **Input**: API specification and optional security assessment results.
  - **Output**: A security risk score with mitigation suggestions.
